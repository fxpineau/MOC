\section{Previous frequency indexing convention\label{sec:apx:fmoc1}}

This section describes the frequency axis indexing scheme that was initially explored before
...
The original idea was to (almost) directly use, as the index at the deepest level,
...
The only difference was that the exponent range of a 64-bit floating-point value was considered too
...
One advantage of this approach was the existence of a perfect bijection between the
...
However, a major issue arose from the representation of the axis using WCS, as used in HiPS 2.0.
