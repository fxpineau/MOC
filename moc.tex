...
be expressed at the maximum resolution.
The sequence of intervals {\bf shall} be stored in the FITS table as pairs
of signed integers.
For orders strictly less than 14, 32-bit signed integers (TFORM1='J')
{\bf may} be used. In this case, the maximum resolution {\bf shall} be 13.
Otherwise, 64-bit signed integers (TFORM1='K') {\bf must} be used,
with a maximum resolution of 29.
