...
Although we expect index arrays to be sorted, we cannot impose
the same constraint on orders, since JSON object members are considered unordered.

\paragraph{Example of a JSON SMOC:}
\par\noindent
\begin{lstlisting}[]
